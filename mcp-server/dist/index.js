    ...
    try {
        ...
        switch (name) {
            case "generate_receipt": {
                const { txHash, chain, clientName, description, businessName, businessAddress } = args;
            ...
            case "create_statement": {
                const { walletAddresses, startDate, endDate, chain } = args;
            ...
            case "create_invoice": {
                const { clientName, clientEmail, amount, token, dueDate } = args;
            ...
            case "add_wallet": {
                const { address, chain, label } = args;
